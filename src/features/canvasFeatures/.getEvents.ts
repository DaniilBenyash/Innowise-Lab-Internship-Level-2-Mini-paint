...
export const getEvents = (typeEvent: enumDraw, context: typeContext, setDraw: (arg: boolean) => any, draw: boolean, image: string | undefined, canvasWidth: number, canvasHeight: number): typeDrawEvent => {
    switch (typeEvent) {
        case enumDraw.Brush:
            return {
